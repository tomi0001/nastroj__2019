    ...
    <table class="table">
        ...
        <tr>
            <td colspan="6" class="center">
                ...
                ->appends(['min2'=>Input::get("min2")])->links();
                @endphp
                @if (isset(Input::get("what_work3")[0]))
                @php    
                $paginate->appends(['what_work3[0]'=>Input::get("what_work3")[0]]);
                @endphp
                @endif
                @if (isset(Input::get("what_work3")[1]))
                @php    
                $paginate->appends(['what_work3[1]'=>Input::get("what_work3")[1]]);
                @endphp
                @endif
                @if (isset(Input::get("what_work3")[2]))
                @php    
                $paginate->appends(['what_work3[2]'=>Input::get("what_work3")[2]]);
                @endphp
                @endif
                @if (isset(Input::get("what_work3")[3]))
                @php    
                $paginate->appends(['what_work3[3]'=>Input::get("what_work3")[3]]);
                @endphp
                @endif
                @php
