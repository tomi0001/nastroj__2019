...
<div class="search">
    <table class="table">
        <form action="{{ url('/ProduktDr/Search_action')}}" method="get">
        <tr>
            <td class="center">
                Nastrój
            </td>
    ...
    <table class="table">
       ...
       <tr>
        ...
        <tr>
            <td colspan="6" class="center">
                <input type="button" onclick="searchAI('{{url('/ProduktDr/actionAI')}}')" value="Szukaj" class="btn btn-primary">
            </td>
        </tr>
        <tr>
        <td colspan="6">
        ...
        <table class="table">
            <form action="{{ url('/PDFDr/generate')}}">
                <tr>
