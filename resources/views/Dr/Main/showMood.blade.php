            ...
            @if ($listMood[$i]["type"] == 1)
                ...
                @endif
                   <tr class='idMood{{$i}}'>
                    <td>
                        @if ($listMood[$i]["drugs"] != "")
                        <button onclick="showDrugs('{{url('/DrugsDr/show')}}',{{$i}},{{$listMood[$i]["id"]}})" class="btn btn-primary">Pokaż leki</button>
                        @else
                    ...
                    <td>
                        ...
                        <button onclick="showDescription('{{url('/MoodDr/showDescription')}}',{{$listMood[$i]["id"]}},{{$i}})" class="btn btn-primary">Pokaż opis</button>
                        @else
